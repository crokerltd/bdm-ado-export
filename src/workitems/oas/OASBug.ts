import { ADOWorkItemBugFields, Bug, isADOBugWorkItem } from "../ado/Bug";
...
export function isOASWorkItemBugFields(x: any): x is OASWorkItemBugFields {
    const result = {
 ...
 * Bug
 */
export class OASBug extends Bug {

    workaround?: string;
    partner?: string;

    constructor(data: ADOWorkItem<OASWorkItemBugFields>, factory: WorkItemFactoryIf, leafNode?: boolean) {
